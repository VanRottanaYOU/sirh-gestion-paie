...
public class JeuxDeDonneesTest {
	...
	public void onSetup() {
	 ...
	 //© Tous droits réservés à Rossi Oddet Partie 2 - Jeux de données | 5
	 ...
	 assertThat(bulletin1.getRemunerationEmploye().getMatricule(),
	 equalTo("M01"));
	 }
	 ...
	 Stream.of("EP01", "EP02", "EP03", "EP04", "EP05", "EP06", "EP07", "EP12","EP19", "EP20", "EPR1", "E900","EP28", "EP37").forEach(code -> assertTrue("verification code " + code,
	 ...
	 Stream.of("SP01","SP02").forEach(code -> assertTrue("verification code " + code,cotisationsImposables.stream().filter(c -> c.getCode().equals
